PROGRAM Dcoeff
	...
	DOUBLE PRECISION :: T, TOUT, RTOL, ATOL, junk(6), params(15), m, Step, N, E, Econst, LE, dE, MAXT
	...
	CALL norm_energy(NumG, q, p, Y, N, Econst, LE, omega, params, phase, npts, x, wts, dE)
	...
	DO 45 WHILE ( TOUT .LE. MAXT )
		...
		END DO
		CALL coeff_matrix( NumG, m, params, omega, phase, q, p, Y, npts, x, wts, Econst, dE, R)
